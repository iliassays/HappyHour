...
namespace HappyEating.Campaign.Function.Canpaign
{
    using System;
    ...
    public class GetRunningCampaignsForUser
    {
        ...
        public GetRunningCampaignsForUser(
            ...
            ILogger<GetRunningCampaignsForUser> logger,
            ...
            string userId)
        {
            ...
            try
            {
                ...
                var result = await campaigns.Find(campaign => campaign.OrganizerId == userId && campaign.CampaignStatus == CampaignStatus.Running).ToListAsync();
